document.addEventListener("DOMContentLoaded", function() {
  ...
  // Zoom Image
  ======================= */
  const lightense = document.querySelector(".page img, .post img, .gallery img"),
  imageLink = document.querySelectorAll(".page a img, .post a img, .gallery a img");
  ...
  if (lightense) {
    Lightense(".page img:not(.no-lightense), .post img:not(.no-lightense), .gallery img:not(.no-lightense)", {
    padding: 60,
    offset: 30
    });
  };
